...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxUnidadDuracion = QComboBox(self.centralwidget)
        self.comboBoxUnidadDuracion.addItem("")
        self.comboBoxUnidadDuracion.addItem("")
        self.comboBoxUnidadDuracion.addItem("")
        self.comboBoxUnidadDuracion.addItem("")
        self.comboBoxUnidadDuracion.setObjectName(u"comboBoxUnidadDuracion")
        self.comboBoxUnidadDuracion.setGeometry(QRect(430, 210, 81, 31))
        font1 = QFont()
        font1.setPointSize(8)
        self.comboBoxUnidadDuracion.setFont(font1)
        self.label_7 = QLabel(self.centralwidget)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(30, 230, 131, 81))
        self.label_7.setFont(font)
        self.comboBoxUnidadFrecuencia = QComboBox(self.centralwidget)
        self.comboBoxUnidadFrecuencia.addItem("")
        self.comboBoxUnidadFrecuencia.addItem("")
        self.comboBoxUnidadFrecuencia.addItem("")
        self.comboBoxUnidadFrecuencia.addItem("")
        self.comboBoxUnidadFrecuencia.setObjectName(u"comboBoxUnidadFrecuencia")
        self.comboBoxUnidadFrecuencia.setGeometry(QRect(430, 260, 81, 31))
        self.comboBoxUnidadFrecuencia.setFont(font1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBoxUnidadDuracion.setItemText(0, QCoreApplication.translate("MainWindow", u"Minutos", None))
        self.comboBoxUnidadDuracion.setItemText(1, QCoreApplication.translate("MainWindow", u"Horas", None))
        self.comboBoxUnidadDuracion.setItemText(2, QCoreApplication.translate("MainWindow", u"Dias", None))
        self.comboBoxUnidadDuracion.setItemText(3, QCoreApplication.translate("MainWindow", u"Semanas", None))

        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Frecuencia:", None))
        self.comboBoxUnidadFrecuencia.setItemText(0, QCoreApplication.translate("MainWindow", u"Minutos", None))
        self.comboBoxUnidadFrecuencia.setItemText(1, QCoreApplication.translate("MainWindow", u"Horas", None))
        self.comboBoxUnidadFrecuencia.setItemText(2, QCoreApplication.translate("MainWindow", u"Dias", None))
        self.comboBoxUnidadFrecuencia.setItemText(3, QCoreApplication.translate("MainWindow", u"Semanas", None))
